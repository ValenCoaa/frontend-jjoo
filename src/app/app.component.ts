...
export class AppComponent { 
  ...
  function toggleDetalles(pais:pais) {
 ...
 */
  ...
  function toggleDetallespais(pais:pais){
    pais.mostrarDetalles =!pais.mostrarDetalles;
  }

  function toggleDeporteDetalles(deporte:deporte){
    deporte.mostrarDetalles = !deporte.mostrarDetalles;
  }


function toggleDetalles(pais: any, pais1: any) {
